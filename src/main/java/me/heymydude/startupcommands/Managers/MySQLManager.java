package me.heymydude.startupcommands.Managers;
...
public class MySQLManager {
    ...
    public static void createTable() {
        try {
            PreparedStatement ps = StartupCommands.connection.prepareStatement(
                    "CREATE TABLE IF NOT EXISTS druuid (UUID VARCHAR(100),Cooldown BIGINT(100),PRIMARY KEY (UUID))");
            ps.executeUpdate();
            PreparedStatement ps2 = StartupCommands.connection.prepareStatement(
